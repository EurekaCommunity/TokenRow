...
* Use [github issues](https://github.com/EurekaCommunity/TokenRow/issues) to report a bug.
* Before creating a new issue:
  * Make sure you are using the [latest release](https://github.com/EurekaCommunity/TokenRow/releases).
  * Check if the issue was [already reported or fixed](https://github.com/EurekaCommunity/TokenRow/issues?utf8=%E2%9C%93&q=is%3Aissue). Notice that it may not be released yet.
...
1. Fork the TokenRow repository.
2. Clone your forked project into your developer machine: `git clone git@github.com:<your-github-username>/TokenRow.git`
3. Add the original project repo as upstream repository in your forked project: `git remote add upstream git@github.com:EurekaCommunity/TokenRow.git`
...
* We use `type: feature request` label to mark all [feature request issues](https://github.com/EurekaCommunity/TokenRow/labels/type%3A%20feature%20request).
